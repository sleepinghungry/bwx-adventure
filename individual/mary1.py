...
sidewalk = game.new_location(
  "house",
  "you climb up the stairs go east to go in to the house.'")
pie_house= game.new_location(
    "pie house",
    "you are a frickin piece of pie you pie.'")
...
kithchen= game.new_location(
  "walk_into_kitchen",
"""you wlak into the door. your mom is in the kitchen baking cookies go north to see your mother.""")
...
room= game.new_location(
  "room",
  """ you meet your mom she tells you cant have any cookies until you do your homework.go south to go to your room.""")
...
game.new_connnection("house ", sidewalk, pie_house, EAST, WEST)


player = game.new_player(pie_house)
