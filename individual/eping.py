...
bottom = game.new_location(
  "Bottom of the Ocean",
  "You are a fish, swimming in the open waters of the Pacific.")
...
reef = game.new_location(
  "Coral Reef",
"""Your comfortable home, safe from dangers.""")

sea_anenome = game.new_location("Sea Anenome", "A safe for a clownfish like you.")
...
game.new_connection("Glass Door", reef, bottom, EAST, WEST)

game.new_connection("reef to anenome", reef, sea_anenome, IN, OUT)
