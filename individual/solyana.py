...
stable = game.new_location(
  "horse stable",
  "There is a super cute horse named chai. chai says 'hello!'")
...
arena = game.new_location(
  "horse arena",
"""A large horse arena.
There is a barn door to the west.""")
...
# but don't worry that it will simply vanish, instead it will be stored in the g

tack = game.new_location(
   "tack room",
   "a room full of tack. There is a western saddle.")
   
game.new_connection("horse pasture", stable, arena, [IN, SOUTH], [OUT, WEST])

#game.new_connection("tack room", sidewalk, vestibule, [IN, SOUTH], [OUT, WEST])    
