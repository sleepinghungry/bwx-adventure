...
candyland = world.create_location("candyland","everything is made out of candy there is a gold key hanging from a near by candycane")
...
candyland.create_object("gold key", "a gold key with skulls ingraved into in")
cirqu.create_object("silver key", "a silver key with roses ingravd it it")
home.create_object("bronze key", "a bronze key with a dimond in the center")
